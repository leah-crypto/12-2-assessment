...
module.exports = {
    ...
    getAdvice: (req, res) => {
        const advice = ["Make sure you get 8 to 10 hours of sleep a day", "Eat the right amount of fruits and veggies", "Dont forget to call your loved ones"];
